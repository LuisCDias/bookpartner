...
public class GenreBooks_Results extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getSupportFragmentManager().findFragmentById(android.R.id.content) == null) {
			GenreBooks_Results_Aux list = new GenreBooks_Results_Aux();
	...
	public static class GenreBooks_Results_Aux extends SherlockListFragment {
